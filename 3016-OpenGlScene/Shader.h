...
public:
	unsigned int ID;
	//---Constructor will read from the file path and read the contents as a string
    Shader(const char* vertexPath, const char* fragmentPath)
    {
        ...
        //--- Shader program holds all the shaders
        // Then links this shader to the OpenGL context
        ID = glCreateProgram();
    ...
    private:
        //--- Utility methods to check shader compilation success
